...
use Modules\Wordpress\Observers\WordpressObserver;
use Modules\Thuoc\Models\Thuoc;
use Modules\Thuoc\Observers\ThuocObserver;
use Modules\Help\Models\Help;
use Modules\Help\Observers\HelpObserver;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    {
        //observe
		Wordpress::observe(new WordpressObserver);
		Thuoc::observe(new ThuocObserver);
		Help::observe(new HelpObserver);
