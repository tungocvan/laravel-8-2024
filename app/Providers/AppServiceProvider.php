...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        //singleton
	$this->app->singleton(
		\Modules\Wordpress\Repositories\WordpressRepositoryInterface::class,
		\Modules\Wordpress\Repositories\WordpressRepository::class,
		);
	$this->app->singleton(
		\Modules\Thuoc\Repositories\ThuocRepositoryInterface::class,
		\Modules\Thuoc\Repositories\ThuocRepository::class,
		);
	$this->app->singleton(
		\Modules\Help\Repositories\HelpRepositoryInterface::class,
		\Modules\Help\Repositories\HelpRepository::class,
		);
	$this->app->singleton(
		\Modules\Menu\Repositories\MenuRepositoryInterface::class,
		\Modules\Menu\Repositories\MenuRepository::class,
		);
	$this->app->singleton(
