    ...
    <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
        ...
        <div class="card-body p-0">
          ...
          <div class="p-4 code-to-copy">
            ...
            <p class="mb-0">Vào terminal cập nhật links tạo từ href, ví dụ: href="post/list"</p>
            <p class="mb-0">
              <pre class="language-html" tabindex="0"><code class="language-html">php artisan create:menu 'post/list'</code></pre>
            </p>
